...
// Function to reverse only the sections of the students
void reverseSections(Student arr[], int n) {
    for (int i = 0; i < n / 2; ++i) {
...
int main() {
    ...
    // Call the function to reverse sections
    reverseSections(students, N);
